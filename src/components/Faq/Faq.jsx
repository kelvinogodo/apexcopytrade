    ...
    <div className='faq-section' id='faq'>
        <div className="faq-wrapper">
            <div className="why-choose-us-text-container faq-p">
                ...
                {/* <p data-aos="fade-up">
                We’ve provided some information about APEXCOPYTRADE, APEXCOPYTRADE Plans, cryptocurrencies, and few other common questions you might want to ask. If you have any other questions, contact our live support system or email address.
                </p> */}
            </div>
        </div>
